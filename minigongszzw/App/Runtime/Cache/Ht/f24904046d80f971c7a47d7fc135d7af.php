...
<div class="aaa_pts_show_1">【 创业补贴管理 】</div>

<div class="aaa_pts_show_2">
    <div>
       <div class="aaa_pts_4"><a href="<?php echo U('Subsidy/index');?>">创业补贴管理</a></div>
    </div>
    <div class="aaa_pts_3">
      ...
      <table class="pro_3">
         <tr class="tr_1">
           ...
           <td style="width:150px;">大图</td>
           <td style="width:200px;">操作</td>
         </tr>
         <tbody id="news_option">
         <!-- 遍历 -->
          <?php if(is_array($subsidy)): $i = 0; $__LIST__ = $subsidy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
             <td><?php echo ($v["name"]); ?></td>
             <td style="padding:3px 0;"><img src="/minigongszzw/Data/<?php echo ($v["photo_x"]); ?>" width="80px" height="80px"/></td>
             <td style="padding:3px 0;"><img src="/minigongszzw/Data/<?php echo ($v["photo_d"]); ?>" width="80px" height="80px"/></td>
            <td>
              <a href="<?php echo U('Subsidy/add');?>?id=<?php echo ($v["id"]); ?>">修改</a>
             </td>
