    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
         ...
         <li data-index="0">
            ...
            <!-- <iframe class="pro_2" src="/minigongszzw/Data/inc/photo_add.php?id=photo_sj0&width=200&height=200" frameborder="0"></iframe> -->
              <?php if ($info['logo']) { ?>
                <img src="/minigongszzw/Data/<?php echo $info['logo']; ?>" width="100" height="100" /><br /><br />
              <?php } ?>
