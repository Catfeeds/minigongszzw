...
<div class="aaa_pts_show_2">
    ...
    <div class="aaa_pts_3">
      <table class="pro_3">
         ...
         <?php if(is_array($server)): $i = 0; $__LIST__ = $server;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
             <td><?php echo ($v["id"]); ?></td>
             <td><?php echo ($v["name"]); ?></td>
             <td><?php echo ($v["phone"]); ?></td>
             <td class="obj_1">
              <a href="<?php echo U('More/set_bottom');?>?id=<?php echo ($v["id"]); ?>">修改</a>
             </td>
