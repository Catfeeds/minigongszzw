...
<div class="aaa_pts_show_1">【 香港公司注册管理 】</div>

<div class="aaa_pts_show_2">
    <div>
       <div class="aaa_pts_4"><a href="<?php echo U('HongKong/index');?>">香港公司注册管理</a></div>
    </div>
    <div class="aaa_pts_3">
      ...
      <table class="pro_3">
         ...
         <!-- 遍历 -->
          <?php if(is_array($hongkong)): $i = 0; $__LIST__ = $hongkong;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
              <a href="<?php echo U('HongKong/add');?>?id=<?php echo ($v["id"]); ?>">修改</a>
             </td>
