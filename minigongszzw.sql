...
Source Database       : minigongszzw

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2017-08-28 08:58:59
*/
...
CREATE TABLE `lr_address` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户收货地址表';

-- ----------------------------
-- Records of lr_address
-- ----------------------------
INSERT INTO `lr_address` VALUES ('3', '李峰', '18814125843', '43', '94', '98', '小村庄', '河北省 邯郸市 复兴区 小村庄', '130404', '1', '0');
INSERT INTO `lr_address` VALUES ('4', 'leefon', '123456789', '43', '94', '100', '大城市', '河北省 邯郸市 邯郸县 大城市', '130421', '1', '1');
INSERT INTO `lr_address` VALUES ('10', 'hahahaha', '12345678985', '380', '408', '414', '5454654', '内蒙古自治区 赤峰市 巴林左旗 5454654', '150422', '1', '0');
...
-- ----------------------------
-- Table structure for `lr_affiliate`
-- ----------------------------
DROP TABLE IF EXISTS `lr_affiliate`;
CREATE TABLE `lr_affiliate` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '地址挂靠ID',
  `name` varchar(255) NOT NULL COMMENT '地址',
  `type` int(11) NOT NULL DEFAULT '1' COMMENT '1:小规模地址；2:一般纳税人地址',
  `server_type` varchar(255) DEFAULT NULL COMMENT '服务类型',
  `server_intro` varchar(255) DEFAULT NULL COMMENT '服务介绍',
  `sale_protected` varchar(255) DEFAULT NULL COMMENT '售后服务',
  `price` int(11) NOT NULL COMMENT '价格',
  `photo_x` varchar(255) NOT NULL COMMENT '小图',
  `photo_string` varchar(255) NOT NULL COMMENT '轮播图',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_affiliate
-- ----------------------------
INSERT INTO `lr_affiliate` VALUES ('1', '猪院运动场西南部', '2', '哈哈哈哈', 'SaaS多', ' 大时代啊', '0', 'UploadFiles/product/20170825/1503643669170161.jpg', 'UploadFiles/product/20170821/1503287354236528.jpg,UploadFiles/product/20170821/1503290256286171.jpg');
INSERT INTO `lr_affiliate` VALUES ('9', '小村庄', '1', '哈哈  哈哈  哈哈', '', '', '666', 'UploadFiles/product/20170826/1503732766257500.jpg', ',UploadFiles/product/20170826/1503732959507023.jpg,UploadFiles/product/20170826/1503732959102760.jpg');
INSERT INTO `lr_affiliate` VALUES ('4', '猪院运动场西北部', '2', '哈哈哈哈', '', '', '0', 'UploadFiles/product/20170825/1503643567352931.jpg', '');
INSERT INTO `lr_affiliate` VALUES ('5', '猪院主席台', '2', '嘻嘻嘻嘻', '', '', '0', 'UploadFiles/product/20170825/1503643742995586.jpg', '');
INSERT INTO `lr_affiliate` VALUES ('6', '猪院运动场东南部', '2', '嘻嘻哈哈', '', '', '0', 'UploadFiles/product/20170825/1503643779387221.jpg', '');
INSERT INTO `lr_affiliate` VALUES ('7', '猪院足球场', '2', '哈哈哈嘻嘻嘻', '', '', '0', 'UploadFiles/product/20170825/1503643836398831.jpg', '');
INSERT INTO `lr_affiliate` VALUES ('8', '猪院大猪栏', '2', '呵呵呵呵呵', '', '', '0', 'UploadFiles/product/20170825/1503643903837817.jpg', '');

-- ----------------------------
-- Table structure for `lr_agency`
-- ----------------------------
DROP TABLE IF EXISTS `lr_agency`;
CREATE TABLE `lr_agency` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名字',
  `title` varchar(255) DEFAULT NULL COMMENT '标题',
  `process` varchar(255) DEFAULT NULL COMMENT '流程',
  `data` varchar(255) DEFAULT NULL COMMENT '所需资料',
  `server_process` varchar(255) DEFAULT NULL COMMENT '服务流程',
  `get_server` varchar(255) DEFAULT NULL COMMENT '获得服务',
  `photo_x` varchar(255) NOT NULL COMMENT '小图',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_agency
-- ----------------------------
INSERT INTO `lr_agency` VALUES ('1', '代理记账', '代理', 'UploadFiles/product/20170821/1503283936436765.jpg', 'fdrgfredgdfg。水电费大富大贵', 'UploadFiles/product/20170821/1503283936209525.jpg', 'UploadFiles/product/20170821/1503283936281138.jpg', 'UploadFiles/product/20170821/1503283936180750.jpg');
...
-- ----------------------------
-- Table structure for `lr_company_adv`
-- ----------------------------
DROP TABLE IF EXISTS `lr_company_adv`;
CREATE TABLE `lr_company_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '注册公司好处ID',
...
-- ----------------------------
-- Records of lr_company_adv
-- ----------------------------
INSERT INTO `lr_company_adv` VALUES ('7', '电饭锅', '电饭锅地方', '1');

-- ----------------------------
-- Table structure for `lr_company_register`
-- ----------------------------
DROP TABLE IF EXISTS `lr_company_register`;
CREATE TABLE `lr_company_register` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '公司注册ID',
  `name` varchar(255) NOT NULL COMMENT '名称',
  `process` varchar(255) DEFAULT NULL COMMENT '注册流程',
  `zheng` varchar(255) DEFAULT NULL COMMENT '正规企业优势',
  `fan` varchar(255) DEFAULT NULL COMMENT '无资质企业',
  `problem` varchar(255) DEFAULT NULL COMMENT '注册常见问题',
  `price` int(11) NOT NULL,
  `photo_x` varchar(255) DEFAULT NULL COMMENT '小图',
  `photo_string` varchar(255) DEFAULT NULL COMMENT '轮播图',
  `server_type` varchar(255) DEFAULT NULL COMMENT '服务类型',
  `server_intro` varchar(255) DEFAULT NULL,
  `sale_protected` varchar(255) DEFAULT NULL COMMENT '售后服务',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_company_register
-- ----------------------------
INSERT INTO `lr_company_register` VALUES ('1', '242', 'UploadFiles/product/20170822/1503361387557424.jpg', '地方郭德纲的风格', '多个电饭锅地方', '电饭锅地方更多', '0', 'UploadFiles/product/20170822/1503361387192683.jpg', 'UploadFiles/product/20170819/1503123113801225.jpg,UploadFiles/product/20170821/1503280733535028.jpg,UploadFiles/product/20170821/1503298590325568.jpg,UploadFiles/product/20170821/1503298590263606.jpg', '受到法国红酒 嘻嘻嘻', '拉谷谷估计', '通过热特儿童热');
...
-- ----------------------------
-- Table structure for `lr_gongsi_change`
-- ----------------------------
DROP TABLE IF EXISTS `lr_gongsi_change`;
CREATE TABLE `lr_gongsi_change` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '公司变更ID',
  `name` varchar(255) NOT NULL COMMENT '名字',
...
-- ----------------------------
-- Records of lr_gongsi_change
-- ----------------------------
INSERT INTO `lr_gongsi_change` VALUES ('1', '2321', '745', '嘻嘻嘻哈哈哈哈', '哈哈哈哈嘻嘻嘻嘻', '呵呵呵呵呵呵', 'UploadFiles/product/20170821/1503302243907061.jpg', 'UploadFiles/product/20170821/1503302243993300.jpg,UploadFiles/product/20170821/1503302329837142.jpg');
...
-- ----------------------------
INSERT INTO `lr_guanggao` VALUES ('2', '首页轮播', 'UploadFiles/adv/20170818/1503022118143718.jpg', '0', '0', '', '', '1');
INSERT INTO `lr_guanggao` VALUES ('5', '首页轮播', 'UploadFiles/adv/20170818/1503022127830408.jpg', '0', '1000', '', '', '1');
INSERT INTO `lr_guanggao` VALUES ('10', '首页轮播', 'UploadFiles/adv/20170818/1503022108757819.jpg', '1493349922', '0', '', '', '1');
...
-- ----------------------------
-- Table structure for `lr_hongkong`
-- ----------------------------
DROP TABLE IF EXISTS `lr_hongkong`;
CREATE TABLE `lr_hongkong` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '香港注册ID',
  `name` varchar(255) NOT NULL COMMENT '名字',
  `process` varchar(255) DEFAULT NULL COMMENT '流程',
  `data` varchar(255) DEFAULT NULL COMMENT '所需资料',
  `price` int(11) DEFAULT NULL COMMENT '价格',
...
-- ----------------------------
-- Records of lr_hongkong
-- ----------------------------
INSERT INTO `lr_hongkong` VALUES ('1', '啊啊啊啊', 'UploadFiles/product/20170821/1503297566828977.jpg', 'UploadFiles/product/20170821/1503297566233918.jpg', '0', '哈开始发挥双方', '风刀霜剑还有图教育', '发广告后台人员', 'UploadFiles/product/20170821/1503297566204605.jpg', 'UploadFiles/product/20170821/1503297566683673.jpg,UploadFiles/product/20170821/1503297797252275.jpg,UploadFiles/product/20170821/1503297831625562.jpg');

-- ----------------------------
-- Table structure for `lr_hong_problem`
-- ----------------------------
DROP TABLE IF EXISTS `lr_hong_problem`;
CREATE TABLE `lr_hong_problem` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '常见问题ID',
  `hong_id` int(11) NOT NULL COMMENT '香港注册ID',
...
-- ----------------------------
-- Records of lr_hong_problem
-- ----------------------------
INSERT INTO `lr_hong_problem` VALUES ('12', '1', '社访问', '生栋覆屋虽然我');
...
-- Records of lr_order
-- ----------------------------
INSERT INTO `lr_order` VALUES ('4', '2017082351525710', null, '0', '1', '431.00', '1503474931', '1', 'weixin', '0.00', '0', '0', '李峰', '18814125843', '河北省 邯郸市 复兴区 小村庄', '130404', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('6', '2017082410254991', null, '0', '1', '7897.00', '1503546015', '1', 'weixin', '0.00', '0', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('7', '2017082451100100', null, '0', '1', '0.00', '1503555459', '1', 'weixin', '0.00', '0', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, 'hahahaha', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('8', '2017082448509853', null, '0', '1', '56544.00', '1503555680', '0', 'weixin', '0.00', '20', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, 'hahahahaha', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('9', '2017082452100501', null, '0', '1', '1313.00', '1503555876', '0', 'weixin', '0.00', '30', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, 'xixixixixi', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('10', '2017082410157555', null, '0', '1', '1313.00', '1503565150', '1', 'cash', '0.00', '0', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('11', '2017082450519950', null, '0', '1', '1313.00', '1503565154', '0', 'cash', '0.00', '40', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('12', '2017082455535699', null, '0', '1', '0.00', '1503565975', '0', 'weixin', '0.00', '10', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('13', '2017082510155559', null, '0', '1', '0.00', '1503633550', '0', 'weixin', '0.00', '0', '0', '李峰', '18814125843', '河北省 邯郸市 复兴区 小村庄', '130404', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('14', '2017082653995154', null, '0', '1', '0.00', '1503712885', '0', 'cash', '0.00', '10', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('15', '2017082610057574', null, '0', '1', '0.00', '1503713821', '1', 'weixin', '0.00', '10', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('16', '2017082610250100', null, '0', '1', '431.00', '1503732511', '0', 'weixin', '0.00', '10', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, '', '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('17', '2017082699489757', null, '0', '1', '0.00', '1503732780', '0', 'weixin', '0.00', '20', '0', 'leefon', '123456789', '河北省 邯郸市 邯郸县 大城市', '130421', null, '', '', '1', null, null, null, '0', null, '0');
...
-- ----------------------------
INSERT INTO `lr_order_product` VALUES ('4', '0', null, '4', '大城市', '431.00', 'UploadFiles/product/20170821/1503294079858636.jpg', null, '1503474931', '1', null);
INSERT INTO `lr_order_product` VALUES ('6', '0', null, '6', '2321', '7897.00', 'UploadFiles/product/20170821/1503302243907061.jpg', null, '1503546015', '1', null);
INSERT INTO `lr_order_product` VALUES ('7', '0', null, '8', '12水电费', '56544.00', 'UploadFiles/product/20170822/1503363786478343.jpg', null, '1503555680', '1', null);
INSERT INTO `lr_order_product` VALUES ('8', '0', null, '9', '242', '1313.00', 'UploadFiles/product/20170821/1503302031529920.jpg', null, '1503555876', '1', null);
INSERT INTO `lr_order_product` VALUES ('9', '0', null, '10', '242', '1313.00', 'UploadFiles/product/20170821/1503302031529920.jpg', null, '1503565150', '1', null);
INSERT INTO `lr_order_product` VALUES ('10', '0', null, '11', '242', '1313.00', 'UploadFiles/product/20170821/1503302031529920.jpg', null, '1503565154', '1', null);
INSERT INTO `lr_order_product` VALUES ('11', '0', null, '12', '啊啊啊啊', '0.00', 'UploadFiles/product/20170821/1503297566204605.jpg', null, '1503565975', '1', null);
INSERT INTO `lr_order_product` VALUES ('12', '0', null, '13', '农村', '0.00', 'UploadFiles/product/20170821/1503287354661390.jpg', null, '1503633550', '1', null);
INSERT INTO `lr_order_product` VALUES ('13', '0', null, '14', '242', '0.00', 'UploadFiles/product/20170822/1503361387192683.jpg', null, '1503712885', '1', null);
INSERT INTO `lr_order_product` VALUES ('14', '0', null, '15', '啊啊啊啊', '0.00', 'UploadFiles/product/20170821/1503297566204605.jpg', null, '1503713821', '1', null);
INSERT INTO `lr_order_product` VALUES ('15', '0', null, '16', '大城市', '431.00', 'UploadFiles/product/20170821/1503294079858636.jpg', null, '1503732511', '1', null);
INSERT INTO `lr_order_product` VALUES ('16', '0', null, '17', '小村庄', '0.00', 'UploadFiles/product/20170826/1503732766257500.jpg', null, '1503732780', '1', null);

-- ----------------------------
-- Table structure for `lr_person_register`
-- ----------------------------
DROP TABLE IF EXISTS `lr_person_register`;
CREATE TABLE `lr_person_register` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '个人注册ID',
  `name` varchar(255) NOT NULL COMMENT '名字',
  `price` int(11) DEFAULT NULL COMMENT '价格',
  `server_type` varchar(255) DEFAULT NULL COMMENT '服务类型',
  `server_intro` varchar(255) DEFAULT NULL COMMENT '服务介绍',
...
-- ----------------------------
-- Records of lr_person_register
-- ----------------------------
INSERT INTO `lr_person_register` VALUES ('1', '嘻嘻嘻', '666', '阿萨德东方饭店规范合格', '胜多负少任务二图', '而突然有一很up很波年过花甲', 'UploadFiles/product/20170822/1503362698269968.jpg', 'UploadFiles/product/20170822/1503362641805566.jpg,UploadFiles/product/20170822/1503362689624026.jpg');
...
-- ----------------------------
-- Table structure for `lr_server_company`
-- ----------------------------
DROP TABLE IF EXISTS `lr_server_company`;
CREATE TABLE `lr_server_company` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '服务公司ID',
  `name` varchar(255) NOT NULL COMMENT '服务公司名',
  `phone` char(11) NOT NULL COMMENT '联系电话',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_server_company
-- ----------------------------
INSERT INTO `lr_server_company` VALUES ('1', '某某公司', '15547856325');
...
-- ----------------------------
-- Table structure for `lr_shebao`
-- ----------------------------
DROP TABLE IF EXISTS `lr_shebao`;
CREATE TABLE `lr_shebao` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '社保代办ID',
  `name` varchar(255) NOT NULL COMMENT '名字',
  `price` int(11) DEFAULT NULL COMMENT '价格',
  `server_type` varchar(255) DEFAULT NULL COMMENT '服务类型',
  `server_intro` varchar(255) DEFAULT NULL COMMENT '服务介绍',
...
-- ----------------------------
-- Records of lr_shebao
-- ----------------------------
INSERT INTO `lr_shebao` VALUES ('1', '社保', '888', '建行卡看见爱上大家看', '偶尔法律环境恢复顺利开机哈市我去sad', '大是大非沪港通花费达到阿萨德是', 'UploadFiles/product/20170821/1503302031529920.jpg', 'UploadFiles/product/20170821/1503302031120498.jpg');
...
-- ----------------------------
-- Table structure for `lr_special_approval`
-- ----------------------------
DROP TABLE IF EXISTS `lr_special_approval`;
CREATE TABLE `lr_special_approval` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '特殊审批ID',
  `name` varchar(255) NOT NULL COMMENT '名字',
  `price` int(11) DEFAULT NULL COMMENT '价格',
  `server_type` varchar(255) DEFAULT NULL COMMENT '服务类型',
  `server_intro` varchar(255) DEFAULT NULL COMMENT '服务介绍',
...
-- ----------------------------
-- Records of lr_special_approval
-- ----------------------------
INSERT INTO `lr_special_approval` VALUES ('1', '12水电费', '555', '斯蒂芬斯蒂芬是否是', '是的范德萨发', '发生的水电费水电费水电费\r\n电饭锅', 'UploadFiles/product/20170822/1503363786478343.jpg', 'UploadFiles/product/20170822/1503363786323851.jpg,UploadFiles/product/20170822/1503363802818295.jpg,UploadFiles/product/20170822/1503363802187476.jpg');
...
-- ----------------------------
-- Table structure for `lr_subsidy`
-- ----------------------------
DROP TABLE IF EXISTS `lr_subsidy`;
CREATE TABLE `lr_subsidy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '创业补贴ID',
  `name` varchar(255) NOT NULL COMMENT '名字',
  `photo_x` varchar(255) NOT NULL COMMENT '小图',
  `photo_d` varchar(255) DEFAULT NULL COMMENT '大图',
  `standard` varchar(255) DEFAULT NULL COMMENT '补贴标准',
  `subsidies` varchar(255) DEFAULT NULL COMMENT '补贴内容',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_subsidy
-- ----------------------------
INSERT INTO `lr_subsidy` VALUES ('1', '41热天', 'UploadFiles/product/20170822/1503367066145461.jpg', 'UploadFiles/product/20170822/1503367377382157.jpg', '补贴标准', '补贴详细');

-- ----------------------------
-- Table structure for `lr_subsidy_more`
-- ----------------------------
DROP TABLE IF EXISTS `lr_subsidy_more`;
CREATE TABLE `lr_subsidy_more` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL COMMENT '标题',
  `content` varchar(255) NOT NULL COMMENT '内容',
  `sub_id` int(11) NOT NULL COMMENT '创业补贴ID',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_subsidy_more
-- ----------------------------
INSERT INTO `lr_subsidy_more` VALUES ('7', '热天', '热天', '1');
INSERT INTO `lr_subsidy_more` VALUES ('6', '他如果地方', '撒大声地', '1');

-- ----------------------------
-- Table structure for `lr_suggest`
-- ----------------------------
DROP TABLE IF EXISTS `lr_suggest`;
CREATE TABLE `lr_suggest` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '建议ID',
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `content` varchar(255) NOT NULL COMMENT '内容',
...
-- ----------------------------
-- Records of lr_suggest
-- ----------------------------
INSERT INTO `lr_suggest` VALUES ('3', '1', '不错，不错，挺好的', '1503537989');
INSERT INTO `lr_suggest` VALUES ('4', '1', '好，很好，非常好', '1503538026');
...
-- Records of lr_user
-- ----------------------------
INSERT INTO `lr_user` VALUES ('1', 'LeeFon', 'LeeFon', 'LeeFon', '', '0', '0', null, null, '0', null, '0', '0', '', '', '0', '0', '0.00', 'normal');
